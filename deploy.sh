...
BASE_DOCKER_HUB_REPO="sgaeng222/alarm-server-blue:latest"  # docker hub repo name

if [ -z "$EXIST_BLUE" ]; then
    BEFORE_COMPOSE_COLOR="green"
    AFTER_COMPOSE_COLOR="blue"
    DOCKER_HUB_IMAGE_BLUE="sgaeng222/alarm-server-blue:latest"
    ...
    DOCKER_HUB_IMAGE_GREEN="sgaeng222/alarm-server-green:latest"
